...
import { Car, MenuIcon, UserCircle, X, ChevronDown, Globe, Phone } from 'lucide-react';
      ...
      <div className="hidden lg:block bg-primary-700 text-white py-1">
        <div className="container flex justify-between items-center">
          <div className="flex items-center space-x-4 text-sm">
            <a href="#" className="flex items-center hover:text-accent-300 transition-colors">
          ...
          <div className="flex items-center space-x-4 text-sm">
            ...
            <a href="#" className="hover:text-accent-300 transition-colors">Rewards</a>
            <a href="#" className="hover:text-accent-300 transition-colors">USD $</a>
            <a href="#" className="hover:text-accent-300 transition-colors">English</a>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {['Car Rentals', 'Locations', 'Deals', 'Vehicle Types', 'For Business'].map((item) => (
                <a
                  key={item}
                  href="#"
        ...
        <div className="md:hidden fixed inset-0 bg-neutral-900 bg-opacity-50 z-50">
          <div className="bg-white h-full w-80 max-w-[80%] flex flex-col animate-slide-up">
            <div className="flex items-center justify-between p-4 border-b">
              <a href="#" className="flex items-center font-bold text-xl text-primary-700">
