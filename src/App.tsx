...
function App() {
  const schemaData = {
    ...
    "description": "Layanan rental mobil Medan terpercaya, murah, dan lepas kunci."
  };
  ...
  return (
    <Router>
      <div className="flex flex-col min-h-screen bg-neutral-50">
        ...
        <meta name="description" content="Sewa mobil Medan lepas kunci atau dengan driver. Armada lengkap, harga mulai 300rb-an. Melayani area Kualanamu dan Sumatera Utara." />
